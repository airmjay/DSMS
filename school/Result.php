...
<div class="result-info">
    ...
    <form id='form-control-csv-resert-5' class="mt-4">
    <label class="d-block">Upload CSV</label>
    <input type="file" class="UploadCSVresult" ><button type='button' class="btn btn-sm btn-primary sm upload_csv_result">Upload CSV</button>
    </form>
	</div>
</div>
</div>
