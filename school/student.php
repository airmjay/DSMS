...
<div class="card border-muted shadow">
   ...
   <form action="" class="card-text row" id='Table_id_print_std'>
        ...
        <div class="form-group col-lg-6 col-xl-6 col-md-6 col-12">
            ...
            <select name='class' class="form-control form-control-sm student-class-check"
             id="studentEmail">
                        <?php 
...
<div class="card-body card-list"> 
   ...
   <div class="btn-group">
    <button class='btn-group-item  btn-sm btn-success boder sm student-add'>Add+</button>
    <button class='btn-group-item  btn-sm btn-primary boder sm take-attendance-std'>Take Attendance</button>
    </div>
    </div>
    <input onkeyup="search_student()" type="search" placeholder="Enter student name or id" class="search-student-input form-control form-control-sm sm" name="">
    <div id="container4">
    ...
    <script type="text/javascript">
      function search_student(){
       val = $('.search-student-input').val();
       $.get('config/school/pagination4.php',{val:val}, function(data)
       {
        search = $('.search-student-input').val().trim();
        showRecordsStudent(10, 1,search);
       })
   }
    function showRecordsStudent(perPageCount, pageNumber, search) {
        $.ajax({
            type: "GET",
