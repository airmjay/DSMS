...
<div class="position-relative card p-3">
	...
	<input type="search" placeholder="Enter tutorname or class or id or token to Search" class="form-control form-control-sm mb-2 mt-2 search-print-examination-1" onkeyup="search_print()" name="">
        <div id="container3">
    ...
    function search_print() {
        val = $('.search-print-examination-1').val();
       $.get('config/school/pagination3.php',{val:val}, function(data)
       {
        search = $('.search-print-examination-1').val().trim();
