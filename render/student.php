...
{
	$session = $_SESSION['StudentloginSchoolSessionPost'];
	$random = $_SESSION['StudentloginSchoolSessionPostrandomdb'];
	$_SESSION['db'] = $random;
...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand  p-1" href="/admin">DSMS</a>
  <a class="navbar-brand" style='font-size: 16px; border:2px solid steelblue; padding: 10px;' href="#">STUDENT</a>
...
<div class='p-2'>
    ...
    ?>
    <h1 class="text-success">WELCOME <?= strtoupper($first)?></h1>
    <div class='row'>
        <div class="col-4 p-2">
...
{
  logout4 = $(this).val();
  $.post('config/logout.php',{logout4:logout4},function(data)
  {
    $('body').html(data);
  })
