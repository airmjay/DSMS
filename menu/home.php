<?php 
 ...
 $row1 = mysqli_num_rows(mysqli_query($conn1,$select));
 if($row1){
  include('home1.php');
 }else{
?>
    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="menu/index.html"><i class="fa fa-university"></i><span><?=$row['school_name']?></span></a>
          <!-- IMG BASED LOGO  -->
          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="menu/blog-archive.html">Register</a></li>                
                <li><a href="menu/blog-single.html">Login</a></li>                
              </ul>
            </li>            
  ...
  <section id="mu-slider">
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="menu/assets/img/slider/1.jpg" alt="img">
        </figure>
      </div>
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="menu/assets/img/slider/2.jpg" alt="img">
        </figure>
      </div>
      <div class="mu-slider-content">
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="menu/assets/img/slider/3.jpg" alt="img">
        </figure>
      </div>
      <div class="mu-slider-content">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6">
                ...
                <a id="mu-abtus-video" href="https://www.youtube.com/embed/HN3pm9qYAUs" target="mutube-video">
                  <img src="menu/assets/img/about-us.jpg" alt="img">
                </a>                
                </div>
              </div>
            </div>
          ...
          <div class="mu-latest-courses-area">
            ...
            <div id="mu-latest-course-slide" class="mu-latest-courses-content">
              <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <a href="#"><img src="menu/assets/img/courses/1.jpg" alt="img"></a>
                  ...
                  <div class="mu-latest-course-single-content">
                    ...
                    <div class="mu-latest-course-single-contbottom">
                      ...
                      <span class="mu-course-price" href="#">Lastest Course</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <a href="#"><img src="menu/assets/img/courses/2.jpg" alt="img"></a>
                    <figcaption class="mu-latest-course-imgcaption">
              ...
              <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <a href="#"><img src="menu/assets/img/courses/3.jpg" alt="img"></a>
                    <figcaption class="mu-latest-course-imgcaption">
                      <a href="#">Academic</a>
                      <span><i class="fa fa-clock-o"></i>Lastest Course</span>
                    </figcaption>
            ...
            <div class="mu-our-teacher-content">
              <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="mu-our-teacher-single">
                    <figure class="mu-our-teacher-img">
                      <img src="menu/assets/img/teachers/teacher-02.png" alt="teacher img">
                      <div class="mu-our-teacher-social">
                        <a href="#"><span class="fa fa-facebook"></span></a>
                        <a href="#"><span class="fa fa-twitter"></span></a>
                        <a href="#"><span class="fa fa-linkedin"></span></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="mu-our-teacher-single">
                    <figure class="mu-our-teacher-img">
                      <img src="menu/assets/img/teachers/teacher-03.png" alt="teacher img">
                      <div class="mu-our-teacher-social">
                        <a href="#"><span class="fa fa-facebook"></span></a>
                        <a href="#"><span class="fa fa-twitter"></span></a>
                        <a href="#"><span class="fa fa-linkedin"></span></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="mu-our-teacher-single">
                    <figure class="mu-our-teacher-img">
                      <img src="menu/assets/img/teachers/teacher-04.png" alt="teacher img">
                      <div class="mu-our-teacher-social">
                        <a href="#"><span class="fa fa-facebook"></span></a>
                        <a href="#"><span class="fa fa-twitter"></span></a>
                        <a href="#"><span class="fa fa-linkedin"></span></a>
          ...
          <div class="mu-testimonial-area">
            <div id="mu-testimonial-slide" class="mu-testimonial-content">
              ...
              <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-img">
                  <img src="menu/assets/img/testimonial-3.png" alt="img">
                </div>
                <div class="mu-testimonial-info">
                  <h4>Rebaca Michel</h4>
              ...
              <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-img">
                  <img src="menu/assets/img/testimonial-2.png" alt="img">
                </div>
                <div class="mu-testimonial-info">
                  <h4>Stev Smith</h4>
                  <span>Happy Student</span>
            ...
            <div class="mu-from-blog-content">
              <div class="row">
                <div class="col-md-4 col-sm-4">
                  <article class="mu-blog-single-item">
                    <figure class="mu-blog-single-img">
                      <a href="#"><img src="menu/assets/img/blog/blog-1.jpg" alt="img"></a>
                ...
                <div class="col-md-4 col-sm-4">
                  <article class="mu-blog-single-item">
                    <figure class="mu-blog-single-img">
                      <a href="#"><img src="menu/assets/img/blog/blog-2.jpg" alt="img"></a>
                      <figcaption class="mu-blog-caption">
                        <h3><a href="#">Lorem ipsum dolor sit amet.</a></h3>
                      </figcaption>                      
                    </figure>
                ...
                <div class="col-md-4 col-sm-4">
                  <article class="mu-blog-single-item">
                    <figure class="mu-blog-single-img">
                      <a href="#"><img src="menu/assets/img/blog/blog-3.jpg" alt="img"></a>
                      <figcaption class="mu-blog-caption">
                        <h3><a href="#">Lorem ipsum dolor sit amet.</a></h3>
                      </figcaption>                      
                    </figure>
