...
$a1 = cleanData($conn, $_POST['a1']);
$a2 = cleanData($conn, $_POST['a2']);
$a3= cleanData($conn, $_POST['a3']);
$a4 = cleanData($conn, $_POST['a4']);
   ...
   $check = getimagesize($_FILES["file"]["tmp_name"]);
    ...
    if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
        ...
        The file ". htmlspecialchars( basename( $_FILES["file"]["name"])). " has been uploaded
         with question</div>";
         $update = "INSERT INTO `question`(`section`, `picture`, `unique_id`, `question1`, `question2`, `question3`, `question4`, `tutor`, `class`, `token`) VALUES ('$section','$imageNamedb','$q1','$a1','$a2','$a3','$a4','$email','$classname','$v1')";
         echo "<script>$('#form_question_1_get_empty')[0].reset();</script>";
    ...
    $update = "INSERT INTO `question`(`section`,`unique_id`, `question1`, `question2`, `question3`, `question4`, `tutor`, `class`, `token`) VALUES ('$section','$q1','$a1','$a2','$a3','$a4','$email','$classname','$v1')";
         echo "<script>$('#form_question_1_get_empty')[0].reset();</script>";
