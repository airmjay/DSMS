...
<div class="row">
    ...
    $row['middleName']; ?></span>
			...
			<span class="d-block mt-1 sm">Phone: 0801223422</span>
...
<?php }?>
	...
	<div class="card shadow mt-2 p-3 border-dark">
		<form>
			...
			<label>Email</label>
			<input type="text" name="" value="<?= $row['email'] ?>"  placeholder="enter your email" class="form-control form-control-sm" readonly>
			<label>Address</label>
